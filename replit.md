...
Features:
- Slash commands: `/ping`, `/kick`, `/ban`, `/unban`, `/timeout`, `/untimeout`, `/warn`, `/warnings`, `/clearwarnings`, `/delwarning`, `/purge`, `/slowmode`, `/userstats`, `/autorole set|clear|show`, `/snipe`, `/lock`, `/unlock`
